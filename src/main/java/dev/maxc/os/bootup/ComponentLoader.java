...
public class ComponentLoader {
    public static final String[] loadingComponents = new String[]{
            ...
            "Parsing memory page size config option...",
            "Parsed memory page size config option.",
            "Parsing virtual memory config option...",
            "Parsed virtual memory config option.",
            "Parsing static memory allocation config option...",
            "Parsed static memory allocation config option.",
